...
%  OUTPUT:
%    Voltage → Bus voltage magnitudes in per-unit
%
...
function [Voltage, Load_Current, S_bus, Sloss] = Loadflow_33bus_PV (h,p)
...
BD(:,2:3)  = 2*BD(:,2:3) / (1000 * Sbase);  % Convert P and Q (kW, kVAr) to pu
